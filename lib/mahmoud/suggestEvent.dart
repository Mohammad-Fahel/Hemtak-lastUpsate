            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  _buildWidgetTF("اسم/عنوان العمل التطوعي", Icons.title),
                  SizedBox(height: 10),
                  _buildWidgetTF("اسم رئيس العمل التطوعي", Icons.person),
                  SizedBox(height: 10),
                  _buildWidgetTF("الرقم الوطني", Icons.featured_video),
                  SizedBox(height: 10),
                  _buildWidgetTF("عدد المتطوعين المتوقع", Icons.people),
                  SizedBox(height: 10),
                  _buildWidgetTF("وصف مختصر للفكرة التطوعية", Icons.description),
                  SizedBox(height: 30),
                  GestureDetector(
                      onTap: () {
                        Navigator.push(
